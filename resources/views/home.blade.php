<x-layout>
    <div
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h1 class="group cursor-pointer text-balance font-semibold tracking-tight text-white text-5xl relative">
                Pustaka<span class="relative inline-block group-hover:w-[60px] group-hover:h-[60px]">
                    <span class="group-hover:opacity-0 transition-all ease-in-out duration-300">w</span>
        ...
        <div class="relative mt-16 h-80 lg:mt-8">
            <img class="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10"
                src="{{ asset('images/HERO_SECTION_1.png') }}" alt="App screenshot" width="1824" height="1080">
        </div>
        <div class="hidden relative lg:flex mt-16 h-80 lg:mt-8">
            <img class="absolute left-0 top-[12em] w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10"
                src="{{ asset('images/HERO_SECTION_2.png') }}" alt="App screenshot" width="1824" height="1080">
        </div>
    </div>
</x-layout>
